local NameofHub = 'Play HUB'
local NameofHub2 = 'Play HUB'
...
function cq()
    ...
    if world1 then
		...
		elseif MyLevel == 10 or MyLevel <= 15 then -- Monkey
            magbring = 400
			Ms = "Monkey [Lv. 14]"
...
Tab11:CreateToggle("ความเร็วในการตี[1]",true,function(d)
    _G.FastAttack1 = d
end)
Tab11:CreateToggle("ความเร็วในการตี[2]",nil,function(d)
    _G.FastAttack2 = d
end)
_G.FastAttack2 = true
wait(0.5)
...
Tab7:CreateToggle("ฆ่าผู้เล่นออโต้",nil,function(value)
...
Tab3:CreateLine()
Tab3:CreateButton("กระโดดย้ำ",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
end)
Tab3:CreateButton("ฮาคิ",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
end)
Tab3:CreateButton("วาป",function()
...
Tab33:CreateLabel("ดาบ")
Tab33:CreateLine()
Tab33:CreateButton("ดาบซามูไร",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Katana")
end)
Tab33:CreateButton("ดาบโจรสลัด",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cutlass")
end)
Tab33:CreateButton("2 ดาบ",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Duel Katana")
end)
Tab33:CreateButton("ค้อนหนาม",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Iron Mace")
end)
Tab33:CreateButton("ท่อ",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Pipe")
end)
Tab33:CreateButton("3ดาบ",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Triple Katana")
end)
Tab33:CreateButton("ดาบ 2 ด้าน",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Dual-Headed Blade")
end)
Tab33:CreateButton("ง้าว",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Bisento")
end)
Tab33:CreateButton("ดาบไม้เท้า",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Soul Cane")
end)
Tab3:CreateLabel("ปืน")
Tab3:CreateLine()
...
dv:CreateDropdown("ซื้อผลอัตโนมัติ",{
    "Bomb-Bomb",
    "Spike-Spike",
    "Chop-Chop",
    "Spring-Spring",
...
du:CreateToggle("ตายอัตโนมัติ", false, function(vu)
    ตายอัตโนมัติ = vu
end)
du:CreateToggle("Auto Awakenr", false, function(vu)
    AutoAwakener = vu
end)
du:CreateToggle("ไปเกาะอัตโนมัติ Island", false, function(vu)
    ไปเกาะอัตโนมัติIsland = vu
end)
du:CreateLine()
du:CreateToggle("Auto Raid", false, function(vu)
    _G.AutoRaid = vu
end)
du:CreateDropdown("เลือกชิป", {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha"}, function(vu)
    _G.เลือกชิป = vu
end)
du:CreateToggle("ซื้อชิปออโต้", false, function(vu)
    ซื้อชิปออโต้ = vu
end)
...
spawn(function()
	pcall(function()
		while wait() do
			if AutoBuychip then
				if not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("เลือกชิป") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("เลือกชิป") then
			...
			pcall(function()
				if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == false then
					if AutoFullySuperhuman then
						if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") and not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("เลือกชิป") or not game:GetService("Players").LocalPlayer.Character:FindFirstChild("เลือกชิป") then
							for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
